  ...
  properties: {
    ...
    completion: {
      ...
      properties: {
        ...
        deliberateScopeCut: { type: 'boolean', description: 'True only if the candidate EXPLICITLY communicated deprioritizing a requirement (comment/message) and delivered the rest polished — deliberate triage, not running out of time' },
      ...
      required: ['verdict', 'requirementsTotal', 'requirementsMet', 'deliberateScopeCut', 'worksCorrectly', 'codeQuality', 'required', 'delivered', 'reasoning', 'outputQuality'],
      ...
      properties: {
        signals: {
          ...
          properties: {
            ...
            verifiedBeforeSubmit: { type: 'boolean', description: 'Verified the work before submitting WITHOUT necessarily editing it: ran it, visibly read it through, or checked an edge case' },
          ...
          required: [
            'modifiedAiOutputBeforeUse', 'caughtAiMistake', 'testedOwnWork', 'verifiedBeforeSubmit',
            'brokeProblemDown', 'promptsImproved', 'explainedReasoning', 'pastedVerbatimNoTesting',
