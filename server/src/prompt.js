...
- A log of paste and typing events (timestamp + character count) from their in-browser editor, if available.
...
4. Identify red flags: did they paste large blocks with no subsequent edits or testing, did they submit code that doesn't address the actual brief, did they show no evidence of understanding what was pasted.
5. Write a 2-3 sentence plain-language summary a non-technical founder could read and understand.
6. Give a recommendation: strong_hire, hire, borderline, or no_hire — based on evidence, not on whether they used AI. Using AI well is a positive signal, not a negative one.
